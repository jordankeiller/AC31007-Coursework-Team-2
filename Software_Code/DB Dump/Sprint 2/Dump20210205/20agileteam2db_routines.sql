...
--
-- Temporary view structure for view `researcher_login`
--

DROP TABLE IF EXISTS `researcher_login`;
/*!50001 DROP VIEW IF EXISTS `researcher_login`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `researcher_login` AS SELECT 
 1 AS `ID`,
 1 AS `Name`,
 1 AS `Username`,
 1 AS `Password`*/;
...
--
-- Final view structure for view `researcher_login`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`20agileteam2`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `researcher_login` AS select `r`.`Researcher_ID` AS `ID`,`r`.`Name` AS `Name`,`l`.`Username` AS `Username`,`l`.`Password` AS `Password` from (`researcher` `r` join `login` `l`) where (`r`.`Researcher_ID` = `l`.`Researcher_ID`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`20agileteam2`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `all_questionnaires` AS select `questionnaire`.`Questionnaire_Name` AS `Questionnaire Name`,`researcher`.`Researcher_ID` AS `Researcher ID`,`researcher`.`Name` AS `Researcher Name`,`questionnaire`.`Questionnaire_ID` AS `Questionnaire ID` from (`questionnaire` join `researcher`) where (`researcher`.`Researcher_ID` = `questionnaire`.`Researcher_ID`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_participant_questionnaire_response` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`20agileteam2`@`%` PROCEDURE `get_participant_questionnaire_response`(participant_id int(10))
BEGIN
	# Gets the responses of the specified participant using the participant id.
	select
		 `qr`.`Response_ID`,
         `qr`.`Question_ID`,
         `qq`.`Question_Description`,
         `qr`.`Question_Option_ID`,
         `qr`.`Participant_ID`,
         `qr`.`Response`
    from `20agileteam2db`.`questionnaire_responses` `qr`,
		`20agileteam2db`.`questionnaire_questions` `qq`
    where
		participant_id = `qr`.`Participant_ID` and `qr`.`Question_ID` = `qq`.`Question_ID`;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_participant_response` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`20agileteam2`@`%` PROCEDURE `get_participant_response`(question_id int(10))
BEGIN
	# Gets the responses of a specified participant using the questionnaire id and the participant id.
	select * from `20agileteam2db`.`questionnaire_responses`
    where question_id = `questionnaire_responses`.`Question_ID`;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `get_questionnaire_response` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`20agileteam2`@`%` PROCEDURE `get_questionnaire_response`(qnaire_id int(10))
BEGIN
	# Gets the responses of a specified questionnaire using the questionnaire id.
	select
		 `qr`.`Response_ID`,
         `qr`.`Question_ID`,
         `qr`.`Question_Option_ID`,
    ...
    from `20agileteam2db`.`questionnaire_responses` `qr`,
		`20agileteam2db`.`questionnaire_questions` `qq`
    where
		qnaire_id = `qq`.`Questionnaire_ID` and `qq`.`Question_ID` = `qr`.`Question_ID`
	group by
		`qr`.`Participant_ID`
	order by
		`qr`.`Participant_ID`;
...
-- Dump completed on 2021-02-05 13:10:04
